...
| `android.app` | Doluysa APK kurulur; boşsa `android.app.package` + `android.app.activity` |
...
İndirilen yolu `android.app` anahtarına yaz.

Komut kopyaları: [docs/appium-cheatsheet.md](docs/appium-cheatsheet.md)
