 ...
 * Ag'a cikmaz: siniflandirma dogrudan bilinen exception tipleriyle denenir, boylece test kararlidir.
 */
@Tag("api")
@DisplayName("API transport error reporting")
class ApiErrorReportingTest extends BaseApiTest {
    ...
    void relativePathWithoutBaseUrlIsExplained() {
        ApiClient clientWithoutBaseUrl = new ApiClient(spec, "");
