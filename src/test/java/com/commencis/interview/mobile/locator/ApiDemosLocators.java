...
/**
 * ApiDemos ana menu ve Views ekranlarina ait locator'lar.
 * Oncelik: accessibilityId > id > UiAutomator selector > XPath.
 */
public final class ApiDemosLocators implements Locators {
    ...
    public static final By SWITCHES_OPTION = PlatformBy.of(AppiumBy.accessibilityId("Switches"), null);
    public static final By MONITORED_SWITCH = PlatformBy.of(
            AppiumBy.id("io.appium.android.apis:id/monitored_switch"), null);
     ...
     * icindeki TextView'da durur. android:id/text1 iki spinner'da da ayni oldugu icin childSelector
     * ile spinner2'ye kapsanir.
     */
